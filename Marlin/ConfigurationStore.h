...
#define EEPROM_ADDR_HYSTERESIS_CORRECTION_X (EEPROM_OFFSET+264) // size=4
#define EEPROM_ADDR_HYSTERESIS_CORRECTION_Y (EEPROM_OFFSET+268) // size=4
#define EEPROM_ADDR_HYSTERESIS_CORRECTION_Z (EEPROM_OFFSET+272) // size=4
#define EEPROM_ADDR_HYSTERESIS_CORRECTION_E (EEPROM_OFFSET+276) // size=4
